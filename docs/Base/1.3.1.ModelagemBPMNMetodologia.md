...
- **Product Owner designado**: A integrante Sophia atuará como Product Owner permanente, em virtude de seu amplo conhecimento do projeto e clara visão do produto
...
- **Refatoração contínua**: Melhorar constantemente o código existente 
- **Pequenas releases**

Para mais informações, consulte http://www.extremeprogramming.org/lessons.html
...
<DIAGRAMA link: https://demo.bpmn.io/>
pegue o xml coloque no demo.bpmn.io e clique em open, ai os xmls interativamente, dentro do scrum-xp/xml/*

Para visualizar este diagrama, você pode copiar este XML e importá-lo em uma ferramenta de modelagem BPMN como [bpmn.io](https://demo.bpmn.io/), [Camunda Modeler](https://camunda.com/download/modeler/), ou [draw.io](https://draw.io) (selecione BPMN como tipo de diagrama).

Este diagrama foi desenvolvido iterativamente, testado e validado no bpmn.io para garantir compatibilidade. O diagrama incorpora as adaptações específicas do nosso processo:
...
WELLS, Don. Extreme Programming: A Gentle Introduction. Disponível em: http://www.extremeprogramming.org/. Acesso em: 4 set. 2025.
...
MOUNTAIN GOAT SOFTWARE. Introduction to Scrum. Disponível em: https://www.mountaingoatsoftware.com/agile/scrum. Acesso em: 4 set. 2025.

COCKBURN, Alistair. Agile Software Development: The Cooperative Game. 2nd Edition. Addison-Wesley Professional, 2006.

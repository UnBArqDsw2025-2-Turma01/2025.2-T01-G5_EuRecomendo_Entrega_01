...
- **Eliminação das Daily Scrums**: Optamos por não realizar reuniões diárias devido à elevada demanda de tempo e incompatibilidade de horários entre os membros da equipe
